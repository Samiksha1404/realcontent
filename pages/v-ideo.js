      ...
      <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border sticky top-[0] z-[99] max-w-full">
        <div className="w-[641.7px] rounded-2xl bg-gray1-600 box-border flex flex-row items-start justify-between py-1.5 pr-[17px] pl-3.5 gap-[20px] max-w-full z-[1] border-[1px] border-solid border-gray1-300 mq450:hidden">
          ...
          <div className="w-[42px] flex flex-col items-start justify-start pt-1 pb-0 pr-px pl-0 box-border">
            <a className="[text-decoration:none] relative leading-[23px] text-[inherit] inline-block min-w-[40px] z-[2]">
              Home
            </a>
          </div>
          <div className="flex flex-col items-start justify-start pt-1 px-0 pb-0">
            <a className="[text-decoration:none] relative leading-[23px] text-[inherit] inline-block min-w-[109px] whitespace-nowrap z-[2]">
              Course Content
            </a>
          </div>
          <div className="flex flex-col items-start justify-start pt-1 px-0 pb-0">
          ...
          <div className="w-[164px] flex flex-row items-start justify-start gap-[20px]">
            ...
            <Button className="cursor-pointer [border:none] p-0 bg-[transparent] h-8 flex-1 relative">
              <img
              ...
              />
              <a
                className="[text-decoration:none] absolute top-[7px] left-[11px] text-xs font-inter text-gray1-500 text-left inline-block w-[46px] h-[18px] min-w-[46px] whitespace-nowrap cursor-pointer z-[3]"
        ...
        <section className="w-[1295px] flex flex-row items-start justify-center py-0 pr-5 pl-0 box-border max-w-full [row-gap:20px] text-left text-lg text-white font-inter mq1100:flex-wrap">
          ...
          <div className="flex-1 flex flex-col items-start justify-start gap-[33px] min-w-[541px] max-w-full mq750:min-w-full mq450:gap-[16px]">
            <div className="self-stretch flex flex-row items-start justify-start relative max-w-full">
              ...
              <div className="flex-1 shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded-3xs bg-gray1-600 box-border flex flex-col items-end justify-start pt-0 px-0 pb-[35.6px] gap-[54.8px] max-w-full z-[2] border-[0px] border-solid border-gray1-300 mq1100:flex-1 mq450:gap-[27px]">
                <img
                ...
                />
                <video
                  className="self-stretch h-[430.5px] rounded-3xs flex flex-col items-end justify-start bg-cover bg-no-repeat bg-[top] z-[1]"
                  controls
                >
                  <source src />
                </video>
                    ...
                    <div className="w-[61px] flex flex-col items-start justify-start gap-[10px]">
                      <div className="self-stretch flex flex-row items-start justify-start">
                        <div className="h-[66.6px] flex-1 relative">
                          ...
                          <img
                            className="absolute top-[12.2px] left-[15px] w-[33px] h-[42.2px] cursor-pointer z-[2]"
                            loading="lazy"
                            alt=""
                            src="/vector-2.svg"
              ...
              <div className="h-[453px] w-[936px] !m-[0] absolute top-[-176px] right-[-165px] flex flex-row items-start justify-start">
                <div className="h-[474px] w-[944px] absolute !m-[0] top-[-21px] right-[-8px]">
                  ...
                  />
                  <img
                    className="absolute top-[74px] left-[840px] w-10 h-10 z-[1]"
                    loading="lazy"
                    alt=""
                    src="/group-3382411.svg"
                  />
                </div>
              </div>
            </div>
            <div className="self-stretch rounded-3xs bg-gray1-600 box-border flex flex-row items-start justify-start pt-[72px] px-8 pb-[43.9px] max-w-full z-[2] text-mid text-dark-foregrounds-fg-base font-readex-pro border-[0px] border-solid border-gray1-300">
              <img
                className="h-[201px] w-[831px] relative rounded-3xs hidden max-w-full"
                alt=""
                src="/rectangle-1126.svg"
              />
              <div className="w-[501.5px] flex flex-col items-start justify-start max-w-full z-[1]">
                <div className="self-stretch flex flex-col items-start justify-start gap-[8.4px] max-w-full">
                  <div className="self-stretch flex flex-col items-start justify-start gap-[8.4px]">
                    ...
                    <textarea className="bg-gray1-800 [outline:none] self-stretch h-[55.7px] rounded-[16.72px] box-border overflow-hidden shrink-0 flex flex-row items-center justify-start pt-[15.8px] pb-4 pr-[317px] pl-[13px] font-inter font-medium text-lgi-5 text-slategray border-[1.4px] border-solid border-gray1-400" />
                  </div>
